  ...
  return (
    <section id="expertise" className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-2 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1 xl:grid-cols-4 xl:grid-rows-1 gap-8">
